// ======================================================================
// \title  LegoPerserveranceRoverTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef LEGOPERSERVERANCEROVER_LEGOPERSERVERANCEROVERTOPOLOGY_HPP
#define LEGOPERSERVERANCEROVER_LEGOPERSERVERANCEROVERTOPOLOGY_HPP
// Included for access to LegoPerserveranceRover::TopologyState and LegoPerserveranceRover::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <LegoPerserveranceRover/Top/LegoPerserveranceRoverTopologyDefs.hpp>

// Remove unnecessary LegoPerserveranceRover:: qualifications
 ...
 * LegoPerserveranceRover::TopologyState see: LegoPerserveranceRoverTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type LegoPerserveranceRover::TopologyState see: LegoPerserveranceRoverTopologyDefs.hpp.
 *
