...
#include <LegoPerserveranceRover/Top/LegoPerserveranceRoverTopology.hpp>
...
void setup()
{
    ...
    LegoPerserveranceRover::TopologyState inputs;
    inputs.uartNumber = 0;
    inputs.uartBaud = 115200;

    // Setup topology
    LegoPerserveranceRover::setupTopology(inputs);
}
